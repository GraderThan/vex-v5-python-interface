...
class vexEnum:
    ...
    Attributes:
        value (int): The numeric value of the enumeration.
        name (str): The string name of the enumeration.

    Args:
        value (int): The numeric value to assign to the enumeration.
        name (str): The string name to assign to the enumeration.
    """

    def __init__(self, value, name):
        """Initializes a new instance of the vexEnum class.

        Args:
            value (int): The numeric value for the enumerated type.
            name (str): The string name for the enumerated type.
        """
        self.value = value
        self.name = name
    ...
    def __str__(self):
        ...
        Returns:
            str: The name of the enumeration.
        """
        return self.name

    def __repr__(self):
        """Returns the official string representation of the enumeration.

        The official string representation is the same as the regular string
        representation, which is the name of the enumeration.
...
class PercentUnits:
    ...
    Attributes:
        PERCENT (PercentUnits): A percentage unit representing values from 0% to 100%.
    """
    ...
    This attribute represents a standard percentage, ranging from 0 to 100 percent.
    It is an instance of the inner `PercentUnits` class.
    """
...
class TimeUnits:
    ...
    Attributes:
        SECONDS (TimeUnits): A time unit representing seconds.
        SEC (TimeUnits): A time unit representing seconds, synonymous with SECONDS.
        MSEC (TimeUnits): A time unit representing milliseconds.
    """
    ...
    """A time unit that represents measurements in seconds.

    This attribute is an instance of the inner `TimeUnits` class representing 
    the standard second as a unit of time.
    """

    SEC = TimeUnits(0, "SECONDS")
    """A time unit that also represents measurements in seconds.

    This attribute is functionally equivalent to SECONDS, offering an alternative 
    naming convention. It is an instance of the inner `TimeUnits` class.
    """

    MSEC = TimeUnits(1, "MSEC")
    """A time unit that represents measurements in milliseconds.

    This attribute represents a millisecond as a unit of time. It is an instance 
    of the inner `TimeUnits` class.
    """
...
class CurrentUnits:
    ...
    Attributes:
        AMP (CurrentUnits): A current unit representing amperes.
    """
    ...
    This attribute signifies the standard unit of electrical current, the ampere. 
...
class VoltageUnits:
    ...
    Attributes:
        VOLT (VoltageUnits): A voltage unit representing volts.
        MV (VoltageUnits): A voltage unit representing millivolts.
    """
    ...
    """A voltage unit that represents measurements in volts.

    This attribute signifies the standard unit of electrical potential, the volt. 
    It is an instance of the inner `VoltageUnits` class.
    """

    MV = VoltageUnits(0, "mV")
    """A voltage unit that represents measurements in millivolts.

    This attribute represents a smaller unit of voltage, the millivolt, useful in 
    more precise measurements of electrical potential. It is an instance of the 
...
class PowerUnits:
    ...
    Attributes:
        WATT (PowerUnits): A power unit representing watts.
    """
    ...
    """A power unit that represents measurements in watts.

    This attribute signifies the standard unit of power, the watt. It is an 
    instance of the inner `PowerUnits` class.
    """
...
class TorqueUnits:
    ...
    Attributes:
        NM (TorqueUnits): A torque unit representing Newton meters.
        INLB (TorqueUnits): A torque unit representing inch pounds.
    """
    ...
    NM = TorqueUnits(0, "NM")
    """A torque unit that represents measurements in Newton meters.

    This attribute signifies a standard unit of torque, Newton meter. It is an 
    instance of the inner `TorqueUnits` class.
    """

    INLB = TorqueUnits(1, "INLB")
    """A torque unit that represents measurements in inch pounds.

    This attribute represents another standard unit of torque, inch pound, offering 
    an alternative to Newton meters. It is an instance of the inner `TorqueUnits` class.
    """
...
class RotationUnits:
    ...
    Attributes:
        DEG (RotationUnits): A rotation unit representing degrees.
        REV (RotationUnits): A rotation unit representing revolutions.
        RAW (RotationUnits): A rotation unit representing raw data form.
    """
    ...
    """A rotation unit that represents measurements in degrees.

    This attribute signifies the unit of angular measurement, degree. It is an 
    instance of the inner `RotationUnits` class.
    """

    REV = RotationUnits(1, "REV")
    """A rotation unit that represents measurements in revolutions.

    This attribute represents the unit of complete cycles or revolutions, useful in 
    various mechanical and engineering contexts. It is an instance of the inner 
    `RotationUnits` class.
    """

    RAW = RotationUnits(99, "RAW")
    """A rotation unit that represents measurements in raw data form.

    This attribute is used for scenarios where rotation data is needed in its raw, 
    unprocessed form. It is an instance of the inner `RotationUnits` class.
    """
...
class VelocityUnits:
    ...
    Attributes:
        PERCENT (VelocityUnits): A velocity unit measured in percentage.
        RPM (VelocityUnits): A velocity unit measured in rotations per minute.
        DPS (VelocityUnits): A velocity unit measured in degrees per second.
    """

    class VelocityUnits(vexEnum):
        """Inner class extending `vexEnum` for defining velocity units.
    ...
    """Represents velocity as a percentage of a predetermined maximum."""

    RPM = VelocityUnits(1, "RPM")
    """Represents velocity in terms of rotations per minute."""

    DPS = VelocityUnits(2, "DPS")
    """Represents velocity in terms of degrees per second."""
...
class DistanceUnits:
    ...
    Attributes:
        MM (DistanceUnits): A distance unit measured in millimeters.
        IN (DistanceUnits): A distance unit measured in inches.
        CM (DistanceUnits): A distance unit measured in centimeters.
    """

    class DistanceUnits(vexEnum):
        """Inner class extending `vexEnum` for defining distance units.
    ...
    """Represents distance in millimeters."""

    IN = DistanceUnits(1, "IN")
    """Represents distance in inches."""

    CM = DistanceUnits(2, "CM")
    """Represents distance in centimeters."""
...
class AnalogUnits:
    ...
    Attributes:
        PCT (AnalogUnits): An analog unit measured in percentage.
        EIGHTBIT (AnalogUnits): An analog unit represented by an 8-bit value.
        TENBIT (AnalogUnits): An analog unit represented by a 10-bit value.
        TWELVEBIT (AnalogUnits): An analog unit represented by a 12-bit value.
        MV (AnalogUnits): An analog unit measured in millivolts.
    """

    class AnalogUnits(vexEnum):
        """Inner class extending `vexEnum` for defining analog units.
    ...
    """Represents an analog value in percentage."""

    EIGHTBIT = AnalogUnits(0, "8BIT")
    """Represents an 8-bit analog value, offering 256 possible states."""

    TENBIT = AnalogUnits(0, "10BIT")
    """Represents a 10-bit analog value, offering 1024 possible states."""

    TWELVEBIT = AnalogUnits(0, "12BIT")
    """Represents a 12-bit analog value, offering 4096 possible states."""

    MV = AnalogUnits(0, "MV")
    """Represents an analog value in millivolts."""
